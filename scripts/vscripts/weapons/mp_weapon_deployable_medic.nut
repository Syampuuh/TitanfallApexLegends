...
void function DeployableMedic_DeployHealRope( HealRopeData ropeData, entity player )
{
	...
	ropeData.playerRopeEndEnt.SetLocalOrigin( localOrigin )
	...
	ropeData.playerRopeEndEnt.NonPhysicsMoveInWorldSpaceToLocalPos( localOrigin, ROPE_SHOOT_OUT_TIME, 0, ROPE_SHOOT_OUT_TIME )
