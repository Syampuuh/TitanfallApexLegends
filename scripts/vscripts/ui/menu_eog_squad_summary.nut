...
void function OnOpen()
{
	...
	foreach ( elem in file.menuData[ menu ].gCards )
	{
		...
		RunClientScript( "UICallback_DisconnectedUpdateThread", menu, statsPanel, muteButton, mutePingButton, muteChatButton, reportButton, inviteButton, null, disconnectedElem, i )
...
void function OnClose()
{
	...
	RunClientScript( "ShowRoundEndSquadResults", false )
}
